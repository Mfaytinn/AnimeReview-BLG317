...
def create_app():
    ...
    # Admin routes
    app.add_url_rule("/admin/dashboard", view_func=views.admin_dashboard, methods=["GET"], endpoint="admin_dashboard")

    # Anime management
    app.add_url_rule("/admin/anime/manage", view_func=views.admin_manage_animes, methods=["GET"], endpoint="admin_manage_animes")
    app.add_url_rule("/admin/anime/add", view_func=views.admin_add_anime, methods=["GET", "POST"], endpoint="admin_add_anime")
    app.add_url_rule("/admin/anime/update/<int:anime_id>", view_func=views.admin_update_anime, methods=["GET", "POST"], endpoint="admin_update_anime")
    app.add_url_rule("/admin/anime/delete/<int:anime_id>", view_func=views.admin_delete_anime, methods=["POST"], endpoint="admin_delete_anime")

    
    # User management
    app.add_url_rule("/admin/users/manage", view_func=views.admin_manage_users, methods=["GET", "POST"], endpoint="admin_manage_users")
    app.add_url_rule("/admin/users/update_role/<int:user_id>", view_func=views.admin_update_user_role, methods=["POST"], endpoint="admin_update_user_role")
    app.add_url_rule("/admin/users/delete/<int:user_id>", view_func=views.admin_delete_user, methods=["POST"], endpoint="admin_delete_user")
